...
sqlite_web_client-main/html/cgi-bin
sqlite_web_client-main/html/cgi-bin/multi_sql.py
sqlite_web_client-main/etc
sqlite_web_client-main/etc/systemd
sqlite_web_client-main/etc/systemd/system
...
sqlite_web_client-main/etc/caddy
